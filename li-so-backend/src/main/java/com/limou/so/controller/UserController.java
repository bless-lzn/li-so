...
import com.limou.so.config.WxOpenConfig;
...
import com.limou.so.model.dto.user.UserAddRequest;
import com.limou.so.model.dto.user.UserLoginRequest;
import com.limou.so.model.dto.user.UserQueryRequest;
import com.limou.so.model.dto.user.UserRegisterRequest;
import com.limou.so.model.dto.user.UserUpdateMyRequest;
import com.limou.so.model.dto.user.UserUpdateRequest;
import com.limou.so.model.entity.User;
import com.limou.so.model.vo.LoginUserVO;
...
import static com.limou.so.service.impl.UserServiceImpl.SALT;
